<?php
    ...
    if(isset($_GET['id']) and !empty($_GET['id']) and $_GET['id'] > 0) {
        ...
        $_SESSION['prev_page'] = "blank.php?id=".$id;
            ...
            <section class="place_info">
                ...
                <div class="info"> 
                    <div class="tags">
                        ...
                        foreach($arr as $tag): 
                        ?>
                            <form action="/php_scripts/similar-tags.php?tags=<?=$tag;?>" method="post">
                                <button class="tag">
                                    <?= $allTags[$tag-1]["Name"]; ?>
                                    <?= ($cnt < $arr_size)?'':' ' ?>
                                </button>
                ...
                <div class="btn-marks">
                    ...
                    <div class="buttons">
                        <button type="submit" class="btn btn-mark btn_like" title="Нравится" <?=isset($user)?:'disabled'; ?>  data-id=<?=$id?>>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill=<?=(isset($isLike) and $isLike==true)?'#198754':'currentColor'?> class="bi bi-hand-thumbs-up ico_like" viewBox="0 0 16 16">
                            ...
                            <div class="counter counter_like">
                                <?=$place['Ulike']?>
                            </div>
                        </button>
                        <button type="submit" class="btn btn-mark btn_dislike" title="Не нравится" <?=isset($user)?:'disabled'; ?>  data-id=<?=$id?>>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill=<?=(isset($isDisike) and $isDisike==true)?"#dc3545":'currentColor'?> class="bi bi-hand-thumbs-down ico_dislike" viewBox="0 0 16 16">
                            ...
                            <div class="counter counter_dislike">
                                <?=$place['Udislike']?>
                            </div>
                        </button>                    
                    </div>
