        ...
        <section class="main_app_background">
            <section class="place_info">
                ...
                <div class="btn-marks">
                    ...
                    <div class="buttons">
                        <form action="/php_scripts/like.php?id=<?=$id?>" method="post">
                            <button type="submit" class="btn btn-mark btn_like" title="Нравится" <?=isset($user)?:'disabled'; ?>>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill=<?=(isset($isLike) and $isLike==true)?'#198754':'currentColor'?> class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                        ...
                        <form action="/php_scripts/dislike.php?id=<?=$id?>" method="post">
                            <button type="submit" class="btn btn-mark btn_dislike" title="Не нравится" <?=isset($user)?:'disabled'; ?>>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill=<?=(isset($isDisike) and $isDisike==true)?"#dc3545":'currentColor'?> class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
